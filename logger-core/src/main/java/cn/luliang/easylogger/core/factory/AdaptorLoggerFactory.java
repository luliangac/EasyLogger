 ...
 *
 */
public class AdaptorLoggerFactory {
            ...
            try {
                ...
                if (classType.getName().equals("org.slf4j.impl.Log4jLoggerFactory")) {
                    ...
                    if (null == logConfigFilePath) {
                        ...
                        URL url = AdaptorLoggerFactory.class.getClassLoader().getResource(log4j_resource_file);
                    ...
                    if (null == logConfigFilePath) {
                        URL url = AdaptorLoggerFactory.class.getClassLoader().getResource(logback_resource_file);
                        Method doConfigure =
